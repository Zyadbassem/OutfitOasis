    ...
    >
      ...
      >
        ...
        <p className="text-[10px] text-[#c9c9c9] max-w-72 font-thin sm:text-[18px] sm:max-w-[70%] lg:text-[15px] lg:max-w-max">
          ...
          statement. Whether you’re looking for timeless classics or the latest
          trends, we have something for everyone. With high-quality fabrics,
          unbeatable prices, and a seamless shopping experience, finding your
          perfect look has never been easier. Enjoy secure payments, fast
          delivery, and exceptional customer service. Refresh your wardrobe
          today and explore the best in online fashion!
        </p>
      </div>
